...
SECRET_KEY = "django-insecure-^i^pqz3lxbmb=*+6wpfz5!s$p)s6c51*_76i!(n1j1ns6@8uus"
...
INSTALLED_APPS = [
    ...
    "cart",  # Custom app for shopping cart functionality
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "cart.context_processors.counter",  # Custom context processor for cart item count
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "omerkamil974@gmail.com"
EMAIL_HOST_PASSWORD = "ywfu jjse ickv iymg"  # not your Gmail login password
